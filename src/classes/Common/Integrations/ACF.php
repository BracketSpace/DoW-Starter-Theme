...
class ACF implements Hookable
{
    ...
    public function acfInit()
    {
        ...
        $pages = $this->config->get('acf.option-pages');
    ...
    {
        return $this->config->getString('blocks.templateFilename') ?? 'template.php';
    }
    ...
    {
        return $this->config->getString('blocks.styleFilename') ?? 'index.scss';
    }
}
